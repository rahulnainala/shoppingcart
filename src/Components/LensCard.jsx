function LensCard(props) {
  function handleClick() {
    console.log("button Clicked");
  }
  return (
    <div className="border-2 shadow-l shadow-white  bg-white rounded-2xl h-300 w-300 flex flex-col justify-center items-center">
      ...
      <div className="p-3 text-black flex flex-col flex-wrap items-center">
        ...
        <p className="mb-1 text-m font-normal text-gray-700">{props.size}</p>
